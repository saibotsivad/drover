...
- **`cli-release-assets.json`**: a small JSON file in the schema
  defined in the "CLI release assets" section of
  [`docs/releases.md`](../releases.md),
...
2. **`.github/workflows/publish-cli.yml`** — reusable workflow
   ...
   - Generate `cli-release-assets.json` from `dist/artifacts.json` in
     the schema documented in the "CLI release assets" section of
     [`docs/releases.md`](../releases.md).
...
it. Schema lives in [`docs/releases.md`](../releases.md); changes to it
require coordinated PRs against both workflows.
