...
// APIError is the typed error for any non-2xx response or transport failure.
...
func (e *APIError) ExitCode() int { return 1 }
...
// parseAPIError builds an APIError from a non-2xx response body. FastAPI
...
func parseAPIError(status int, body []byte) *APIError {
	...
	return &APIError{Status: status, Kind: "api_error", Detail: detail}
}
